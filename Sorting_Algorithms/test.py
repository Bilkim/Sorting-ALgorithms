...
def testcase_9_1():
    ...
    print("Test Case data: ",data["testcase_9_1"][1][15948: 15957])
    print("Sorted data: ",testcase_9_1[1][15948: 15957])
    print(df2[['startYear', 'runtimeMinutes', 'primaryTitle']][15948: 15957])
    
    print("Sorted data using algorithm 9_1")
    print(df1[['startYear', 'runtimeMinutes', 'primaryTitle']][15948: 15957])
